...
backgroundURL=this.getClass().getResource("abg.jpg");
...
l2.setBackground(new Color(73,3,3));
l2.setFont(f2);
l2.setBounds(150,550,200,50);
add(l2);
l3=new Label("HINTS REMAINING:" + hints);
l3.setForeground(Color.WHITE);
l3.setBackground(new Color(73,3,3));
l3.setFont(f2);
